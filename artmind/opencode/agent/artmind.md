...
requests through the artmind skills: artmind-query for questions, artmind-update for adding facts, artmind-refine for graph maintenance, artmind-ingestion-helper for ingesting documents.
